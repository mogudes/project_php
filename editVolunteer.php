...
<html lang="en">
    <head>
        ...
        <link href="editVolunteer.css" rel="stylesheet">
    ...
    // session_start();
        ...
        if (isset($_GET['id'])) {
            ...
            $selectAllVolunteerWorkCommand = "SELECT * FROM volunteer_work " ;
            $volunteerAllWorkResults = mysqli_query($dbConnection, $selectAllVolunteerWorkCommand);
        ...
        if (isset($_POST['btnEdit'])) {
            ...
            $updateCommand = "UPDATE volunteer SET Volunteer_Work_Id = '$volunteerWork' ";
            $result = mysqli_query($dbConnection, $updateCommand);

            header("Location: editVolunteer.php?success=Volunteer has been updated successfully.&id=$studId");
        }
        ?>
        <div class="container-fluid d-flex" id="bodyPage">
            <div class="table">
                <div class="container booking-container">
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="volunteerForm">
                    ...
                    <?php } ?>
                        ...
                        <p>Are you sure you want to edit the following volunteer ?</p>
                       ...
                       <?php echo "<input type='text' name='studentID'  value=".$studId." hidden > "?>
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <p>Student Name : </p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col"><h4>Editing Volunteer's Work</h4></div>
                        </div>
                        
                        <div class="row">
                            <div class="col-12">Current Work : </div>
                            <?php
                            while ($data = mysqli_fetch_array($volunteerAllWorkResults)) {
                        ...
                        <br>
                        <button class="btn" type="submit" name="btnEdit" value="Yes" >Yes</button>
